...
2. 按一下桌面捷徑，程式開始讀取
   ...
   ![主視窗](mockups/mockup-1-主視窗.png)

3. 跳出一個確認視窗，顯示程式讀到的料號、數量、交期；格式有自動轉換的會標示提醒，有問題的地方可以直接在視窗裡修改，或勾選跳過，看過沒問題再按「確認」

   ![預覽確認視窗](mockups/mockup-2-預覽確認視窗.png)

4. 程式同時產出兩份檔案：工單 Excel（可直接用或寄給工廠）、ERP 批次匯入檔
5. 跳出結果視窗，一次看到哪些訂單成功、哪些需要補資料，並提示下一步要去 ERP 匯入哪幾筆

   ![結果視窗](mockups/mockup-3-結果視窗.png)

6. 妳去 ERP 點一下匯入，不用再手動打第二次

> 以上畫面是示意圖（mockup），用來說明大概的操作流程，還沒有真正開發。
